...
---@class Seat : IComponent
Seat = class(IComponent)
Seat.maxChildCount = 10
Seat.maxParentCount = 10
Seat.connectionOutput = sm.interactable.connectionType.seated + sm.interactable.connectionType.logic
Seat.connectionInput = sm.interactable.connectionType.logic
...
function Seat:server_onCreate()
    self.interactable.publicData = {E = 0, consumptionE = self.data.consumptionE, maxE = self.data.maxE}
end

function Seat:server_onFixedUpdate()
...
function Seat:server_onDestroy()
