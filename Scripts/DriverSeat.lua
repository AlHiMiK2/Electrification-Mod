...
DriverSeat.connectionOutput = sm.interactable.connectionType.seated + sm.interactable.connectionType.power + sm.interactable.connectionType.bearing + sm.interactable.connectionType.logic
DriverSeat.connectionInput = sm.interactable.connectionType.logic
...
function DriverSeat:server_onCreate()
	Seat.server_onCreate(self)
end

function DriverSeat:server_onFixedUpdate()
...
function DriverSeat:server_onDestroy()
	Seat.server_onDestroy(self)
end
